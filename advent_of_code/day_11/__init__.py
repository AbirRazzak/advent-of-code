...
class GalaxyDistanceDeterminer:
    ...
    def __init__(self, empty_x: set[int], empty_y: set[int]):
        self.empty_x = empty_x
        self.empty_y = empty_y

    def get_distance_between_galaxies(self, g1: tuple[int, int], g2: tuple[int, int]):
        num_expanded_x = 0
        ...
        return manhattan_distance + num_expanded_x + num_expanded_y
...
def main():
    ...
    while True:
        try:
            ...
            g1, g2 = galaxy_pair
            total_distance += distance_determiner.get_distance_between_galaxies(
                g1=g1, g2=g2
            )
